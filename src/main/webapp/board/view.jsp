...
<hr/>
<a href="/board/list.jsp"><button>목록</button></a><a href="/board/modify.jsp?boardNum=<%=boardNum %>"><button>수정</button></a><a href="/board/deletePage.jsp?boardNum=<%=boardNum%>"><button>삭제</button></a>
</body>
</html>
